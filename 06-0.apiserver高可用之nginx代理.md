...
stream {
    upstream backend {
        ...
        server 172.26.56.224:6443          max_fails=3 fail_timeout=30s;
        server 172.26.56.228:6443          max_fails=3 fail_timeout=30s;
        server 172.26.56.234:6443          max_fails=3 fail_timeout=30s;
    }
