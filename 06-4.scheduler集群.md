...
```
$ sudo netstat -tunlp | grep kube-scheduler
tcp6       0      0 :::10251                :::*                    LISTEN      5827/kube-scheduler
```
...
metadata:
  annotations:
    control-plane.alpha.kubernetes.io/leader: '{"holderIdentity":"k8s-master03_7a3aa79b-5428-11e9-b55b-066d760005d9","leaseDurationSeconds":15,"acquireTime":"2019-04-01T02:47:41Z","renewTime":"2019-04-01T02:53:17Z","leaderTransitions":1}'
  creationTimestamp: "2019-04-01T02:47:06Z"
  name: kube-scheduler
  namespace: kube-system
  resourceVersion: "2084"
  selfLink: /api/v1/namespaces/kube-system/endpoints/kube-scheduler
  uid: 700741cc-5428-11e9-9c43-06fb7a0005cf
```

可见，当前的 leader 为 k8s-master03 节点。
...
```
no kind "KubeSchedulerConfiguration" is registered for version "componentconfig/v1alpha1" in scheme "k8s.io/kubernetes/pkg/scheduler/apis/config/scheme/scheme.go:29"
```

问题原因：

```
the api version componentconfig/v1alpha1 has been deprecated since 1.9 is not supported in 1.13, which should be changed to apiVersion: kubescheduler.config.k8s.io/v1alpha1
```

解决：

替换`componentconfig/v1alpha1`为`kubescheduler.config.k8s.io/v1alpha1`。
